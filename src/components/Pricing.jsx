...
const plans = [
  ...
  },
  {
    name: "Pro",
    price: "59.99",
    description: "Ideal for users who want faster results",
    features: [
  ...
  },
  {
    name: "Elite",
    price: "89.99",
    description: "For committed users who want the full experience",
    features: [
      "All Pro features",
      "1-on-1 coach session monthly",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
          {plans.map((plan, key) => (
            ...
            >
              <div className="absolute inset-0 bg-linear-to-br from-white/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform -translate-x-full translate-y-full group-hover:translate-x-0 group-hover:translate-y-0 pointer-events-none"></div> 
              {plan.mostPopular && (
        ...
        <div className="mt-8 sm:mt-12 text-center">
            <p className="text-gray-400 text-base text-xl">
                Need a Custom Plan? <a href="#" className="text-blue-400 hover:text-blue-300">Contact Our Sales Teams</a>
            </p>
        </div>
      </div>
    </section>
